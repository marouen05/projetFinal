...
public class MyTableModel extends AbstractTableModel{
    ...
    String[] header = {"Num_Client","Nom","Prenom","cin","Adresse","Email","Login","Mot de Passe","Date naissance"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex)
        {
            ...
            case 7: return maliste.get(rowIndex).getMdp();
                case 8: return maliste.get(rowIndex).getDate_naiss();
            default:
                return null;
        }
}
